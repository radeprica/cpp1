...
public:
    ...
    GroupPuzzlePiecesIterator<K> get(const Puzzle2dPiece<K>);
    void print_me();
...
/****************************/
template<int K>
GroupPuzzlePieces<K>::GroupPuzzlePieces(typename std::list<Puzzle2dPiece<K>>::iterator begin, typename std::list<Puzzle2dPiece<K>>::iterator end)
{
...
// TODO: make get recieve a puzzle piece or other structure that can be made by initialization
template<int K>
GroupPuzzlePiecesIterator<K> GroupPuzzlePieces<K>::get(const Puzzle2dPiece<K> cond)
    {
        GroupPuzzlePiecesIterator<K> matching_pieces;
        unsigned int l = 0, t = 0, r = 0, b = 0;
        
        int left_cond = cond.get_left_side_shape();
        int top_cond = cond.get_top_side_shape();
        int right_cond = cond.get_right_side_shape();
        int bottom_cond = cond.get_bottom_side_shape();
...
template<int K>
void GroupPuzzlePieces<K>::print_me()
    {
        int l = 0, t = 0, r = 0, b = 0;
